...
import mmr.littledelicacies.utils.manager.StabilizerManager;
import mmr.littledelicacies.world.event.MaidSpawner;
import mmr.littledelicacies.world.event.WanderMaidSpawner;
...
public class LittleDelicacies {
    ...
    public static void debug(String s) {
        LittleDelicacies.LOGGER.debug(s);
    }
