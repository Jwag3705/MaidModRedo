package mmr.littledelicacies.client.maidmodel.animal.squrriel;//Made with Blockbench
...
import mmr.littledelicacies.client.maidmodel.ModelMultiMMMBase;
...
//			mainFrame.rotationPointY += 5.00F;
    ...
    public void setDefaultPause(T entity, float limbSwing, float limbSwingAmount, float ageInTicks,
        ...
        this.bone3.rotateAngleX = 0.6981F;
        this.bone4.rotateAngleX = 1.0996F;
        this.bone5.rotateAngleX = 1.309F;
        ...
        this.bone3.rotateAngleX += MathHelper.sin(ageInTicks * 0.067F) * 0.05F;
        this.bone4.rotateAngleX += MathHelper.sin(ageInTicks * 0.067F) * 0.05F;
        this.bone5.rotateAngleX += MathHelper.sin(ageInTicks * 0.067F) * 0.05F;
