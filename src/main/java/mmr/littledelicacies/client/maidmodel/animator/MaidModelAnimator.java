package mmr.littledelicacies.client.maidmodel.animator;
...
import mmr.littledelicacies.client.maidmodel.Transform;
...
public class MaidModelAnimator {
    ...
    /**
     * @return a new MaidModelAnimator instance
     */
    public static MaidModelAnimator create() {
        return new MaidModelAnimator();
    }

    public IMaidAnimation getEntity() {
        return this.entity;
    }
     ...
     */
    public void update(IMaidAnimation entity) {
     ...
     */
    public boolean setAnimation(MaidAnimation animation) {
        this.tempTick = this.prevTempTick = 0;
