...
@OnlyIn(Dist.CLIENT)
public class MaidFishingBobberRender extends EntityRenderer<MaidFishingBobberEntity> {
    ...
    public MaidFishingBobberRender(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
    }

    public void doRender(MaidFishingBobberEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        LittleMaidBaseEntity playerentity = entityIn.getAngler();
    ...
    public ResourceLocation getEntityTexture(MaidFishingBobberEntity entity) {
        return BOBBER;
    }
}