...
import mmr.littledelicacies.client.model.TrinityModel;
...
public class TrinityRender<T extends TrinityEntity> extends MobRenderer<T, TrinityModel<T>> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(LittleDelicacies.MODID, "textures/entity/trinity.png");
