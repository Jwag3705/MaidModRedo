...
import mmr.littledelicacies.entity.ZombieMaidEntity;
...
public class ZombieMaidRender<T extends ZombieMaidEntity> extends MobRenderer<T, ZombieMaidModel<T>> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(LittleDelicacies.MODID, "textures/entity/zombie_maid.png");
