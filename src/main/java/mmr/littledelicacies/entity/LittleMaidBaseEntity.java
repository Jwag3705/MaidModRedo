...
import mmr.littledelicacies.entity.data.MaidData;
import mmr.littledelicacies.entity.misc.MaidFishingBobberEntity;
import mmr.littledelicacies.entity.pathnavigator.MaidGroundPathNavigator;
import mmr.littledelicacies.entity.phantom.SugarPhantomEntity;
import mmr.littledelicacies.entity.tasks.JobTasks;
import mmr.littledelicacies.entity.tasks.MaidTasks;
import mmr.littledelicacies.init.*;
import mmr.littledelicacies.inventory.InventoryMaidEquipment;
import mmr.littledelicacies.inventory.InventoryMaidMain;
...
*/
  ...
  /*  public void travel(Vec3d p_213352_1_) {
    ...
    public void onSpawnWithEgg() {
        ...
        LittleDelicacies.LOGGER.debug("init-ID:%d, %s:%d", getEntityId(), textureData.textureBox[0].textureName, textureData.getColor());
...
//		recallRenderParamTextureName(textureModelNameForClient, textureArmorNameForClient);
    ...
    public void setTexturePackName(TextureBox[] pTextureBox) {
        ...
        setTextureNames();
        LittleDelicacies.LOGGER.debug("ID:%d, TextureModel:%s", getEntityId(), textureData.getTextureName(0));
