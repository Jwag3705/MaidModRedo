...
public class BigTreePieces {
    private static final ResourceLocation bigtree = new ResourceLocation(LittleDelicacies.MODID, "bigtree");
    private static final ResourceLocation bigtree2 = new ResourceLocation(LittleDelicacies.MODID, "bigtree_2");
