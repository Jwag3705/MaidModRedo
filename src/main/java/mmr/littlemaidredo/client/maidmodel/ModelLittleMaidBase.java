...
//			Skirt.setRotationPoint(0.0F, 5.8F, 2.7F);
	...
	public void setDefaultPause(float par1, float par2, float pTicksExisted,
		...
		bipedTorso.setRotationPoint(0F, 0F, 0F);bipedTorso.setRotateAngle(0F, 0F, 0F);
		bipedNeck.setRotationPoint(0F, 0F, 0F);bipedNeck.setRotateAngle(0F, 0F, 0F);
		bipedPelvic.setRotationPoint(0F, 7F, 0F);bipedPelvic.setRotateAngle(0F, 0F, 0F);
		bipedHead.setRotationPoint(0F, 0F, 0F);
		bipedHead.setRotateAngleDegY(pHeadYaw);
		bipedHead.setRotateAngleDegX(pHeadPitch);
		bipedBody.setRotationPoint(0F, 0F, 0F);bipedBody.setRotateAngle(0F, 0F, 0F);
		...
		Skirt.setRotationPoint(0F, 0F, 0F);Skirt.setRotateAngle(0F, 0F, 0F);
