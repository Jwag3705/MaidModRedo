...
//		GL11.glScalef(0.85F, 0.85F, 0.85F);
		...
		if ((!ModelCapsHelper.getCapsValueBoolean(pEntityCaps, caps_isOverdriveDelay) &&
			...
			bipedRibbonR.setRotationPoint(-3.5F, 0F, 4F);bipedRibbonR.setRotateAngleDeg(15F - bipedHead.getRotateAngleDegX() + (isSneak ? 10F : 0F), 0F, 10F);
			bipedRibbonRSensorU.setRotationPoint(0F, 1F, -0.2F);bipedRibbonRSensorU.setRotateAngleDeg(10F, 0F, 0F);
			bipedRibbonRSensorB.setRotationPoint(0F, 2F, -0.9F);bipedRibbonRSensorB.setRotateAngleDeg(0F, 0F, 0F);
			bipedSideTailR.setRotationPoint(0F, 2F, 0F);bipedSideTailR.setRotateAngleDeg(0F, 0F, 0F);
			
			bipedRibbonL.setRotationPoint(3.5F, 0F, 4F);bipedRibbonL.setRotateAngleDeg(15F - bipedHead.getRotateAngleDegX() + (isSneak ? 10F : 0F), 0F, -10F);
			bipedRibbonLSensorU.setRotationPoint(0F, 1F, -0.2F);bipedRibbonLSensorU.setRotateAngleDeg(10F, 0F, 0F);
			bipedRibbonLSensorB.setRotationPoint(0F, 2F, -0.9F);bipedRibbonLSensorB.setRotateAngleDeg(0F, 0F, 0F);
			bipedSideTailL.setRotationPoint(0F, 2F, 0F);bipedSideTailL.setRotateAngleDeg(0F, 0F, 0F);
...
//			float lf = bipedHead.rotateAngleX > 0 ? -bipedHead.rotateAngleX / 2F : 0F;
			...
			bipedRibbonR.setRotationPoint(-4F, -6F, 2F);bipedRibbonR.setRotateAngleDeg(0F, -90F + lf, 90F);
			bipedRibbonRSensorU.setRotationPoint(0F, 1F, -0.2F);bipedRibbonRSensorU.setRotateAngleDeg(30F, 0F, 0F);
			bipedRibbonRSensorB.setRotationPoint(0F, 2F, -0.9F);bipedRibbonRSensorB.setRotateAngleDeg(-45F, 0F, 0F);
			bipedSideTailR.setRotationPoint(0F, 2F, 0F);bipedSideTailR.setRotateAngleDeg(-80F, 0F, 0F);
			
			bipedRibbonL.setRotationPoint(4F, -6F, 2F);bipedRibbonL.setRotateAngleDeg(0F, 90F - lf, -90F);
			bipedRibbonLSensorU.setRotationPoint(0F, 1F, -0.2F);bipedRibbonLSensorU.setRotateAngleDeg(30F, 0F, 0F);
			bipedRibbonLSensorB.setRotationPoint(0F, 2F, -0.9F);bipedRibbonLSensorB.setRotateAngleDeg(-45F, 0F, 0F);
			bipedSideTailL.setRotationPoint(0F, 2F, 0F);bipedSideTailL.setRotateAngleDeg(-80F, 0F, 0F);
