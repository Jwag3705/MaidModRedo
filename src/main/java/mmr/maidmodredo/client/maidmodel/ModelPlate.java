...
public class ModelPlate extends ModelBoxBase {
	 ...
	 */
	public ModelPlate(RendererModel pMRenderer, Object... pArg) {
	...
	private void init(RendererModel modelrenderer, int pTextureX, int pTextureY,
	...
	public float getU(RendererModel pRender, int pU) {
		float lf = pU / pRender.textureWidth;
		return lf;
	}

	public float getV(RendererModel pRender, int pV) {
