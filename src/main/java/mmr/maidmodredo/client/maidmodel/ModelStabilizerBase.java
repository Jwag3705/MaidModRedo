...
public abstract class ModelStabilizerBase<T extends LivingEntity> extends ModelBase<T> {
...
/*	
	 ...
	 * レンダリングは基本こちらを呼ぶこと
	 */
	public void render(ModelMultiBase<T> pModel, Entity par1Entity, float par2, float par3, float par4, float par5, float par6, float par7) {
