...
import mmr.maidmodredo.client.model.RootModel;
...
public class RootRender extends EntityRenderer<RootEntity> {
    private static final ResourceLocation ROOT = new ResourceLocation(MaidModRedo.MODID, "textures/entity/root.png");
