...
import mmr.maidmodredo.client.model.item.LongSpearModel;
...
public class LongSpearItemRender extends ItemStackTileEntityRenderer {
    private final static ResourceLocation SPEAR_TEXTURE = new ResourceLocation(MaidModRedo.MODID, "textures/entity/long_spear.png");
