...
public class LittleMaidBaseEntity extends TameableEntity implements IModelCaps, IModelEntity, IMaidAnimation, ICrossbowUser {
     ...
     * |アーマーのテクスチャインデックス<br>
     */
    protected static final DataParameter<Integer> dataWatch_Texture = EntityDataManager.createKey(LittleMaidBaseEntity.class, DataSerializers.VARINT);
    /**
     * モデルパーツの表示フラグ(Integer)
     */
    protected static final DataParameter<Integer> dataWatch_Parts = EntityDataManager.createKey(LittleMaidBaseEntity.class, DataSerializers.VARINT);
