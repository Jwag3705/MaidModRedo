...
public class MaidHostilesSensor extends Sensor<LittleMaidEntity> {
    ...
    private Optional<LivingEntity> func_220989_a(LittleMaidEntity p_220989_1_) {
    ...
    private Optional<List<LivingEntity>> func_220990_b(LittleMaidEntity p_220990_1_) {
        return p_220990_1_.getBrain().getMemory(MemoryModuleType.VISIBLE_MOBS);
    }

    private int func_220983_a(LittleMaidEntity p_220983_1_, LivingEntity p_220983_2_, LivingEntity p_220983_3_) {
