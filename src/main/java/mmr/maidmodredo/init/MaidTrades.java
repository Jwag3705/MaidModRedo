...
public class MaidTrades {
    ...
    public static final Int2ObjectMap<VillagerTrades.ITrade[]> planterTrade = func_221238_a(ImmutableMap.of(1, new VillagerTrades.ITrade[]{new SugerCoinForItemsTrade(Items.OAK_WOOD, 42, 6, 4)
